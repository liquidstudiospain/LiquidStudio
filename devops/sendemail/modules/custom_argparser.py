...
def parse_args():
    ...
    # Notify Invalid Branch Name Error
    branch_help = 'Notifies about invalidad names in branches'
    branch_name_parser(subparsers.add_parser('branch_name', help=branch_help))

    # Notify Code Quality Test Failure
    code_help = 'Notifies about critical violations in code'
    code_quality_parser(subparsers.add_parser('code_quality', help=code_help))
...
def branch_name_parser(subparser):
    ''' Add branch name arguments to passed subparser '''
    subparser.add_argument('--recipients', '-r', required=True, nargs='+',
                           help='Recipients of the email')
    subparser.add_argument('--recipientsCC', '-rCC', default=[], nargs='+',
                           help='Carbon Copy recipients of the email')
...
def code_quality_parser(subparser):
    ''' Adds code quality arguments to passed subparser '''
    pass  # TODO
